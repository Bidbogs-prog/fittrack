  ...
  return (
    <div className="blueprint relative min-h-[100dvh] overflow-hidden">
      ...
      <main className="relative z-10 mx-auto w-full max-w-[1100px] px-6 pb-24">
        ...
        <h1 className="mt-3 max-w-[24ch] font-display text-4xl font-bold leading-tight tracking-tighter text-paper md:text-5xl">
          {editing
            ? "Body changed? Targets should too."
            : "Tell us about your body. We'll do the math."}
        </h1>
        <p className="mt-3 max-w-[58ch] text-sm leading-relaxed text-paper-dim">
