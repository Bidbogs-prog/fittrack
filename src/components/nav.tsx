      ...
      {links.map(({ href, label, icon: Icon }) => {
        ...
        return (
          <Link
            ...
            className={`btn-press flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] max-md:flex-col max-md:gap-1 max-md:px-2 max-md:py-1.5 max-md:text-[11px] ${
              active
