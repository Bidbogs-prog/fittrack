...
/**
 * AI coach card: on-demand Gemini analysis of one diary day.
 * Mount with key={date} so state resets when the user changes day.
 */
export function AiInsights({ date, hasEntries }: { date: string; hasEntries: boolean }) {
  const [result, setResult] = useState<DayInsights | null>(null);
